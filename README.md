...
2. Open the three platforms:
    a. Open [http://localhost:8080/lively4-core/start.html?load=http://localhost:8080/sandblocks-text-artifact/lively-demo.md]() in a browser, which should open a file browser-like interface on the left with an editor on the right (tested on Chrome 142.0.7444.175).
